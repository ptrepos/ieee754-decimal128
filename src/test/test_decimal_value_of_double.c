...
void test_decimal_value_of_double()
{
	...
	value_test(1111111111111111111111111111111111111111111111111111.0, 10000000000000000000000000000000000.0);
	value_test(0.11111111, 0.0000000000000000001);
	value_test(0.1111111111111111111111, 0.0000000000000000001);
	value_test(0.1111111111111111111111111111111111111, 0.0000000000000000001);
	value_test(0.123456789123456789132456798123456798123456798123465798, 0.0000000000000000001);
	value_test(0.000000000000000000000000000123456789123456789123456789, 0.0000000000000000000000000000000000000000000001);
