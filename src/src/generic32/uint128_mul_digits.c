...
MG_PRIVATE int mg_uint128_mul_digits(const mg_uint128 *op1, int op1_words, const mg_uint128 *op2, int op2_words, /*out*/mg_uint128 *ret)
{
	...
	memcpy(ret->word, buf, sizeof(buf[0]) * MG_UINT128_SIZE);
	return 0;
}
